...
|---------|---------|-------------|
| Plan and Manage Customer Service Operations | 6.2 | Core owner of ticket intake, resolution, and SLA management |
| Service Products After Sales | 6.3 | Handles complaint intake and routes to appropriate resolution paths |
