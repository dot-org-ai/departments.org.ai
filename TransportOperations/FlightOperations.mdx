...
|---------------|-------------|
| manageFlightPlanning | Develop and file flight plans including routes, fuel calculations, and weather analysis |
...
```mermaid
graph LR
  createFlightPlan --> reviewFuelPolicy
  reviewFuelPolicy --> assignAircraft
