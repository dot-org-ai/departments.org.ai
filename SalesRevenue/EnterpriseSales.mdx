...
|---------|---------|-------------|
| Develop Sales Forecast | 3.4.1 | Enterprise targeting, quota, and coverage model derive from sales strategy |
| Manage Leads/Opportunities | 3.5.1 | Core process for managing complex enterprise deal progression |
| Manage Customers and Accounts | 3.5.2 | Strategic account management and expansion planning |
