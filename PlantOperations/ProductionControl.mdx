...
|---------|---------|-------------|
| Plan for and Align Supply Chain Resources | 4.1 | Receives demand-driven planned orders that become work orders |
| Produce/Assemble/Test Product | 4.3 | Directly manages work order execution across manufacturing operations |
