...
```mermaid
graph LR
  submitWorkOrder --> assignTechnician
  assignTechnician --> performMaintenance
  performMaintenance --> inspectWork
  inspectWork --> closeWorkOrder
```
...
|---------|---------|-------------|
| Manage Physical Assets | 10.1 | Core process for facilities lifecycle management |
| Manage Capital Assets | 10.2 | Governs capital improvements and building investments |
...
| Health, Safety & Environment | Aligns on workplace safety standards and compliance |
