...
|---------|---------|-------------|
| Manage IT Operations | 8.6 | Core process for incident management, monitoring, and service delivery |
| Manage IT Portfolio | 8.2 | Informs asset lifecycle decisions and service catalog investments |
| Manage Enterprise Architecture | 8.1 | Aligns service catalog offerings with enterprise architecture standards |
