...
|---------|---------|-------------|
| Manage Enterprise Architecture | 8.1 | Defines application standards and integration patterns |
| Manage IT Portfolio | 8.2 | Governs application rationalization and investment decisions |
| Manage IT Operations | 8.6 | Coordinates application monitoring and production support |
