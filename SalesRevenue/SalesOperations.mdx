...
|---------|---------|-------------|
| Develop Sales Strategy | 3.4.1 | Territory planning and quota setting operationalize the sales strategy |
| Manage Sales Pipeline | 3.4.3 | Provides pipeline analytics and forecasting infrastructure for deal management |
| Manage Sales Orders | 3.4.4 | Deal desk supports pricing and contract structuring for order execution |
