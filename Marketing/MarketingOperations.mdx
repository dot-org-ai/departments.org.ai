...
|---------|---------|-------------|
| Develop Marketing Strategy | 3.2 | Provides data infrastructure and analytics to inform strategy development |
| Develop and Manage Sales Plans | 3.5 | Operates attribution models and dashboards that measure program effectiveness |
| Manage Trade Pricing, Promotions, and Allowances | 3.3.6 | Maintains data quality and integration across marketing systems |
