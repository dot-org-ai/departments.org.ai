...
|---------|---------|-------------|
| Deliver Products and Services | 4.4 | Fleet availability directly determines delivery capacity and service levels |
| Manage Health, Safety, and Environment | 5.5 | Vehicle inspections and maintenance compliance are core safety requirements |
| Manage Enterprise Asset Lifecycle | 5.3 | Fleet vehicles are capital assets requiring lifecycle planning and depreciation tracking |
