...
| configurNurtureSequence | Set up automated email drip workflows with triggers and segmentation |
...
graph LR
  ...
  buildLandingPage --> configurNurtureSequence
  configurNurtureSequence --> analyzeAttribution
