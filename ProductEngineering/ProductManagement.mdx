...
|---------|---------|-------------|
| Develop Products and Services | 2.1 | Owns product strategy, concept development, and lifecycle management |
| Define Product/Service Development Requirements | 2.1.2 | Responsible for gathering and documenting product requirements |
| Manage Product and Service Portfolio | 2.3 | Drives portfolio-level prioritization and sunset decisions |
