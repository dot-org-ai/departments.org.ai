...
|---------|---------|-------------|
| Develop and Manage Services/Solutions | 8.5 | Core process for provisioning and maintaining technology infrastructure |
| Develop and Manage IT Resilience and Risk | 8.3 | Drives disaster recovery, failover, and business continuity planning |
| Deploy Services/Solutions | 8.6 | Coordinates day-to-day monitoring and incident response for infrastructure |
