...
|---------|---------|-------------|
| Establish Service Delivery Governance and Strategies | 5.1 | Professional services engagements are a core component of post-sale customer service |
| Manage Service Delivery Resources | 5.2 | Feedback from implementations informs product and service improvement |
