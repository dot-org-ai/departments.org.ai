...
|---------|---------|-------------|
| Manage Compliance | 11.2 | Core process for regulatory monitoring and compliance program management |
| Manage Enterprise Risk | 11.1 | Governs the control environment that supports compliance objectives |
