...
```mermaid
graph LR
  assessLitigationRisk --> engageOutsideCounsel
  engageOutsideCounsel --> conductDueDiligence
  conductDueDiligence --> draftResolution
  draftResolution --> fileAnnualReport
```
...
|---------|---------|-------------|
| Manage Legal and Ethical Issues | 12.4 | Core process for corporate governance and legal compliance |
| Build Investor Relationships | 12.1 | Coordinates with government relations on regulatory filings |
