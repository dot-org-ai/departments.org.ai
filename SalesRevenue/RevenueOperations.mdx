...
|---------|---------|-------------|
| Develop Sales Forecast | 3.4.1 | Revenue operations provides forecasting data and process insights to inform sales strategy |
| Manage Leads/Opportunities | 3.5.1 | Funnel optimization and metric governance support pipeline management |
