...
|---------|---------|-------------|
| Manage Information | 8.4 | Governs data standards, metadata, and information lifecycle |
| Deploy Services/Solutions | 8.6 | Coordinates pipeline monitoring, alerting, and incident response |
| Develop and Manage IT Customer Relationships | 8.1 | Aligns data platform design with enterprise architecture standards |
