...
graph LR
  ...
  filePatent --> prosecuteApplication
  prosecuteApplication --> maintainRegistration
  maintainRegistration --> enforceRights
```
...
|---------|---------|-------------|
| Manage Legal and Ethical Compliance | 11.1 | Governs IP enforcement and legal risk management |
| Protect Intellectual Property | 11.3 | Core process for patent and trademark lifecycle management |
