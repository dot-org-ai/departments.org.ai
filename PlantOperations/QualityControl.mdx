...
|---------|---------|-------------|
| Produce/Assemble/Test Product | 4.3 | Inspects in-process and finished output at defined production stages |
| Design and Construct Productive Assets | 10.2 | Calibrates and maintains quality measurement instruments |
