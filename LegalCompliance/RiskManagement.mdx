...
graph LR
  ...
  assignRiskOwner --> developMitigation
  developMitigation --> monitorAndReport
  monitorAndReport --> escalateRisk
```
...
| Information Security | Aligns on cybersecurity risk identification and mitigation |
