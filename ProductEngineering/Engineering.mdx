...
|---------|---------|-------------|
| Design and Build Products and Services | 2.2 | Core owner of software design, development, and delivery |
| Manage Product and Service Development Programs | 2.1.4 | Executes development programs from sprint planning through release |
| Test and Validate Products and Services | 2.2.4 | Responsible for automated testing and validation before release |
