...
|---------|---------|-------------|
| Develop and Manage IT Resilience and Risk | 8.3 | Core process governing security policy, risk management, and data protection |
| Manage Information | 8.4 | Partners on information security, privacy, and data protection |
| Deploy Services/Solutions | 8.6 | Coordinates monitoring, alerting, and operational incident response |
