...
graph TD
    ...
    seniorProjectManager -->|delegatesTo| projectCoordinator
...
|---------|---------|-------------|
| Manage Portfolio, Program, and Project | 13.2 | Core owner of project governance and portfolio management |
| Define the Business Concept and Long-Term Vision | 1.1 | Ensures project portfolio aligns with strategic business plans |
